...
batting_team= st.selectbox('Select the Batting Team ',('Chennai Super Kings', 'Delhi capitals', 'Kings XI Punjab','Kolkata Knight Riders','Mumbai Indians','Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad' , 'India','australia','pakistan'))
